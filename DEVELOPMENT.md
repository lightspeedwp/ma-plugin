...
The plugin follows WordPress block development best practices with multiple blocks:
...
- `@` → `src/` directory
- `@blocks` → `src/` directory
- `@utils` → `src/shared/utils/` directory
- `@components` → `src/shared/components/` directory
