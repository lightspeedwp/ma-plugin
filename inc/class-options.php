...
class Options {
	 ...
	 * @var string
	 */
	const OPTIONS_PAGE = 'ma_plugin_settings';
	 ...
	 * @var string
	 */
	const FIELD_GROUP = 'group_ma_plugin_options';
	...
	public function register_options_pages() {
		...
		acf_add_options_page(
			array(
				'page_title'      => __( 'Medical Academic Enhancements Settings', 'ma-plugin' ),
				'menu_title'      => __( 'Medical Academic Enhancements', 'ma-plugin' ),
	...
	public function register_options_fields() {
		...
		acf_add_local_field_group(
			array(
				...
				'fields'          => array(
					// Tab: Branding.
					array(
						'key'   => 'field_ma_plugin_tab_branding',
						'label' => __( 'Branding', 'ma-plugin' ),
						'type'  => 'tab',
					),
					array(
						'key'           => 'field_ma_plugin_logo',
					...
					// Tab: Social Media.
					array(
						'key'   => 'field_ma_plugin_tab_social',
						'label' => __( 'Social Media', 'ma-plugin' ),
						'type'  => 'tab',
					),
					array(
						'key'          => 'field_ma_plugin_social_links',
						'label'        => __( 'Social Links', 'ma-plugin' ),
						'name'         => 'ma_plugin_social_links',
						'type'         => 'repeater',
						'layout'       => 'table',
						'button_label' => __( 'Add Social Link', 'ma-plugin' ),
						'sub_fields'   => array(
							array(
								'key'     => 'field_ma_plugin_social_platform',
							...
							array(
								'key'   => 'field_ma_plugin_social_url',
		...
		acf_add_local_field_group(
			array(
				...
				'fields'   => array(
					array(
							'key'          => 'field_ma_plugin_items_per_page',
							'label'        => __( 'Items Per Page', 'ma-plugin' ),
							'name'         => 'ma_plugin_items_per_page',
						'type'         => 'number',
						'default'      => 12,
						'min'          => 1,
						'max'          => 100,
					...
					array(
							'key'          => 'field_ma_plugin_layout',
							'label'        => __( 'Archive Layout', 'ma-plugin' ),
							'name'         => 'ma_plugin_layout',
						'type'         => 'button_group',
						'choices'      => array(
					...
					array(
							'key'          => 'field_ma_plugin_show_sidebar',
							'label'        => __( 'Show Sidebar', 'ma-plugin' ),
							'name'         => 'ma_plugin_show_sidebar',
						'type'         => 'true_false',
						'ui'           => 1,
						'default'      => 1,
							'instructions' => __( 'Display sidebar on archive and single views.', 'ma-plugin' ),
								...
								array(
									'key'          => 'field_ma_plugin_featured_image_size',
									'label'        => __( 'Featured Image Size', 'ma-plugin' ),
									'name'         => 'ma_plugin_featured_image_size',
									'type'         => 'select',
									'choices'      => array(
		...
		acf_add_local_field_group(
			array(
				...
				'fields'   => array(
					...
					array(
						'key'          => 'field_ma_plugin_api_cache_duration',
						'label'        => __( 'Cache Duration', 'ma-plugin' ),
						'name'         => 'ma_plugin_api_cache_duration',
						'type'         => 'number',
						'default'      => 3600,
						'min'          => 0,
	...
	public static function get_option( $field_name, $default = '' ) {
		...
		$value = get_field( 'ma_plugin_' . $field_name, 'option' );
	...
	public static function update_option( $field_name, $value ) {
		...
		return update_field( 'ma_plugin_' . $field_name, $value, 'option' );
	}
}
